...
| Strategy | Metric Impact | Result |
|----------|---------------|--------|
| **Cross-Docking** | Reduces **DIO** | Inventory moves faster; less capital is trapped. |
| **Early Payment Discounts** | Increases **DPO** (net) | Strategic use of cash to lower COGS. |
| **Electronic Invoicing** | Reduces **DSO** | Faster billing cycles improve daily liquidity. |
...
Subject to: **Supplier Relationship Stability** and **Customer Service Levels**
